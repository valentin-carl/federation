...
def handlePreFetchingRequest(inputDict: Dict[str, Any]) -> str:
    ...
    cmd = f"python3 prefetchsubp.py {filename} {aws_access_key_id} {aws_secret_access_key} {bucket} {object}".split(' ')

    subprocess.Popen(cmd)
    print(f"started subprocess in background to download file {filename}")
